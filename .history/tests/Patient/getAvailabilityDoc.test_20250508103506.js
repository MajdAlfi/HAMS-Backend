...
const router = require('../../src/Doctor/get/getDocAva'); // adjust path
const weekModel = require('../../src/Model/weeklySchedule');

jest.mock('../../src/Model/weeklySchedule'); // ✅ Mock Mongoose model
...
describe('GET /getWeeklySchedule', () => {
  ...
  it('should return 200 and weekly schedule data', async () => {
    ...
    weekModel.find.mockResolvedValue(mockData); // ✅ mock success
